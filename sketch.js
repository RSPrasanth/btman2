...
var thunder1,thunder2 ,thunderImg1 , thunderImg2 , thunderImg3,thundersound;
function preload(){
  // load bg image
  backgroundImg = loadImage("Image/rainbg.jpg");
  // load both thunder images
    thunder1 = loadImage("Image/i1 (1).png");
    thunder2 = loadImage("Image/i1 (2).png");
    thundersound = loadSound("Image/thundr04.mp3")
}
